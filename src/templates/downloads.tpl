...
<div class="content">
	...
	<% } else { %>
	<div class="well">No compiled, ready-to-run releases are currently available.  Please <a href="#contact">contact us</a> for more information. </div>
	<% } %>
	<% } %>
	...
	<% } else { %>
	<div class="well">No development repositories are currently available.  Please <a href="#contact">contact us</a> for more information. </div>
	<% } %>
	<% } %>
	...
	<p>Once you have downloaded your copy of the <%= application.name %> software, then you will need to install it on your system by following <a href="#installation">these instructions</a>. </p>
</div>