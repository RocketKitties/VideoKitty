...
import UserNotificationsView from '../../../../views/apps/notification-center/dropdowns/user-notifications-view.js';
...
export default UserNotificationsView.extend(_.extend({}, Timeable, {
	...
	fetchNotificationsSince(date, options) {
		new Notifications().fetch({
			data: {
				after: date? date.format('yyyy-mm-dd HH:MM:ss', false) : undefined
			},
	...
	updateNotifications: function() {
		...
		//
		this.fetchNotificationsSince(this.lastDate, {
