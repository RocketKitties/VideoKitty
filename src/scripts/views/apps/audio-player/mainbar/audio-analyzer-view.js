/******************************************************************************\
|                                                                              |
|                            audio-analyzer-view.js                            |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a view used for showing an audio analyzer.               |
|                                                                              |
...
export default BaseView.extend(_.extend({}, Animatable, {
	...
	showBars: function() {
		...
		// let fbcArray = new Uint8Array(this.analyzer.frequencyBinCount);
		let fbcArray = new Uint8Array(numBars);		
		this.analyzer.getByteFrequencyData(fbcArray);
	...
	onStart: function() {
		...
		//
		if (sound) {
			sound.gainNode.connect(this.analyzer);
		}

		// connect analyzer to audio output
		//
		this.analyzer.connect(audio.context.destination);
